...
from django.urls import path, include           #! start at project lvl,  include allow us to include all the files in our project

urlpatterns = [
    path('admin/', admin.site.urls),
    path('', include('main_app.urls'))          #! we are mounting to the main page
]
